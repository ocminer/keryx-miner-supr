#!/usr/bin/env bash
# mmpOS launcher for keryx-miner-supr (AMD/OpenCL, PoM). Maps the mmpos generic
# flags (--pool/--user/--password/--api-port) onto keryx's CLI and enables the
# built-in /mmpos stats endpoint.
#
